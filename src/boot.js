...
import flamingoTired from '../assets/other/flamingoTired.png'
...
import praderaSpecCutout from '../assets/jsons/distritosEspeciales/NUEVA_PRADERA.json';
import saharSpecCutout from '../assets/jsons/distritosEspeciales/SAHAR.json';
import somosaguaSpecCutout from '../assets/jsons/distritosEspeciales/SOMOSAGUA.json';
...
export default class Boot extends Phaser.Scene {
  ...
  create() {
    ...
    this.load.image('flamingoTired', flamingoTired);
    ...
    this.cache.json.add('borrascalCutout', borrascalCutout);
    this.cache.json.add('nidoCutout', nidoCutout);
    this.cache.json.add('guineaCutout', guineaCutout);
    ...
    this.cache.json.add('praderaSpecCutout', praderaSpecCutout);
    this.cache.json.add('saharSpecCutout', saharSpecCutout);
    this.cache.json.add('somosaguaSpecCutout', somosaguaSpecCutout);
